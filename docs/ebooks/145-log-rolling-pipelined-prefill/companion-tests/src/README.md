...
- `queueing-subsumption.test.ts`: queueing containment boundary checks.
...
- `map-reduce-readiness.test.ts`: §6.13 readiness diagnostic equations.
...
- `evidence-traceability.test.ts`: provenance/citation checks for evidence constants.
