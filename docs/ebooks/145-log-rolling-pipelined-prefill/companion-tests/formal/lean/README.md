...
- `Lean/ForkRaceFoldTheorems/BeautyOptimality.lean`: constructive linear/additive beauty theorems showing that deficit definitions, deficit-monotone latency and waste, zero-deficit Pareto optimality, strict positive-penalty separation, additive composition, and the higher-level beauty schema all admit a concrete witness model.
...
- `Lean/ForkRaceFoldTheorems/InterferenceCoarsening.lean`: constructive graph-quotient special case for the interference boundary, deriving positive coarse repair debt from an injective live-support quotient under deterministic collapse and including a small app-stage witness.
