...
exports.OfflineOperationQueue = void 0;
...
// ============================================================================
class OfflineOperationQueue extends eventemitter3_1.EventEmitter {
  constructor(maxQueueSizeOrOptions = 1000, defaultMaxRetries = 3) {
    super();
    this.queue = new Map();
    this.syncingIds = new Set();
...
OfflineOperationQueue.DEFAULT_PERSIST_KEY = 'aeon:offline-queue:v1';
// ============================================================================
// Singleton Instance
// ============================================================================
...
//# sourceMappingURL=OfflineOperationQueue.js.map
